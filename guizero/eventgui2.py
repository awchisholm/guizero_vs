...
# this is the first text box asking for your name
...
# this is the Done button - when you press it the function is called
btn_go = PushButton(app, command=btn_go_clicked, text="Done")
# this is the Done button - when you press it the function is called
btn_go2 = PushButton(app, command=btn_go2_clicked, text="Done")
